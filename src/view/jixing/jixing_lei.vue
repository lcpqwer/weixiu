<template>
  <div>
    <Button style="margin-right: 5px" type="info" @click="add">新增</Button>
    <!--搜索-->
    <Input clearable placeholder="请输入机型大类关键字搜索" class="search-input" v-model="juti_name" style="width: 200px;margin-right: 3px"/>
    ...
    <Modal
      ...
      <Form :model="formAdd" :label-width="80" :rules="ruleValidate" ref="formAdd">
        <FormItem label="机型大类" prop="juti_name">
  ...
  export default {
    ...
    methods: {
      ...
      xiugai(row){
        ...
        // this.formItem.juti_name=row.name
      },
      ok (formItem) {
